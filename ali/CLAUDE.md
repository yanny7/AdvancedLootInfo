...
- `ConfigUtils` — reads/writes `config/ali/ali_common.json` (`Utils.COMMON_CONFIG_NAME`), handles `CURRENT_VERSION` migration by renaming the outdated file to `.bak` and regenerating defaults.
