...
public class AliClientRegistry implements IClientRegistry, IClientUtils {
    ...
    private final Map<ResourceLocation, BiFunction<IClientUtils, RegistryFriendlyByteBuf, IDataNode>> dataNodeFactoryMap = new HashMap<>();
    private final Map<ResourceLocation, BiFunction<IClientUtils, RegistryFriendlyByteBuf, ITooltipNode>> tooltipNodeFactoryMap = new HashMap<>();
    ...
    @Override
    public void registerDataNode(ResourceLocation id, BiFunction<IClientUtils, RegistryFriendlyByteBuf, IDataNode> dataFactory) {
        dataNodeFactoryMap.put(id, dataFactory);
    }

    @Override
    public void registerTooltipNode(ResourceLocation id, BiFunction<IClientUtils, RegistryFriendlyByteBuf, ITooltipNode> tooltipFactory) {
