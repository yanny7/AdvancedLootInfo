...
public class RegistriesTooltipTest {
    ...
    public void testAttributeTooltip() {
        assertTooltip(RegistriesTooltipUtils.getAttributeTooltip(UTILS, "ali.property.value.attribute", Attributes.JUMP_STRENGTH.value()), List.of("Attribute: minecraft:generic.jump_strength"));
    }
    ...
    public void testEntitySubPredicateTooltip() {
        assertTooltip(RegistriesTooltipUtils.getEntitySubPredicateTooltip(UTILS, "ali.property.value.variant", EntitySubPredicates.catVariant(LOOKUP.lookupOrThrow(Registries.CAT_VARIANT).getOrThrow(CatVariant.CALICO))), List.of("Variant: minecraft:cat"));
    }

    @Test
    public void testCatVariantTooltip() {
        assertTooltip(RegistriesTooltipUtils.getCatVariantTooltip(UTILS, "ali.property.value.variant", LOOKUP.lookupOrThrow(Registries.CAT_VARIANT).getOrThrow(CatVariant.CALICO).value()), List.of("Variant: minecraft:calico"));
    }
    ...
    assertTooltip(RegistriesTooltipUtils.getFrogVariantTooltip(UTILS, "ali.property.value.variant", LOOKUP.lookupOrThrow(Registries.FROG_VARIANT).getOrThrow(FrogVariant.TEMPERATE).value()), List.of("Variant: minecraft:temperate"));
    }
