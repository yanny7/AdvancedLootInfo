...
import com.yanny.aci.test.utils.*;
...
public class NodeCodecTest {
    ...
    // TooltipNode encoding goes through ComponentSerialization, whose static init needs the registries
    @BeforeAll
    ...
    public void testNestedTreeSurvivesTheRoundTrip() {
        ...
        TestListNode decodedBranch = (TestListNode) decodedRoot.nodes().getFirst();
    ...
    public void testDuplicateChunkIsIgnored() {
        ...
        receiver.messageReceived(0, chunks.getFirst());
