...
public class PluginManager {
    ...
    private static List<com.yanny.ali.manager.PluginHolder> PLUGINS;
    ...
    private static void registerCommonData() {
        ...
        for (com.yanny.ali.manager.PluginHolder plugin : PLUGINS) {
            try {
    ...
    @NotNull
    private static List<com.yanny.ali.manager.PluginHolder> getPlugins() {
        List<com.yanny.ali.manager.PluginHolder> plugins = new LinkedList<>();
            ...
            for (ModFileScanData.AnnotationData annotationData : scanData.getAnnotations()) {
                if (type.equals(annotationData.annotationType())) {
                    try {
                        ...
                        LOGGER.warn("Failed to load {} plugin with error: {}", Utils.MOD_ID, t.getMessage());
                    }
                }
            }
        }
