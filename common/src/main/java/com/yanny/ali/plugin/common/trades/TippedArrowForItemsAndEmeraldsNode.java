...
public class TippedArrowForItemsAndEmeraldsNode extends ListNode {
    ...
    public TippedArrowForItemsAndEmeraldsNode(IServerUtils utils, VillagerTrades.TippedArrowForItemsAndEmeralds listing) {
    ...
    public TippedArrowForItemsAndEmeraldsNode(IClientUtils utils, RegistryFriendlyByteBuf buf) {
        super(utils, buf);
