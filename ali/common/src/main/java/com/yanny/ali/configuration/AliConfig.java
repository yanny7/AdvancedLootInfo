...
public class AliConfig {
    ...
    public AliConfig() {
        ...
        blockCategories.add(new BlockLootCategory(Utils.modLoc("plant_loot"), Items.DIAMOND_HOE, false, of(), List.of(VegetationBlock.class)));
        ...
        gameplayCategories.add(new GameplayLootCategory(Utils.modLoc("chest_loot"), Items.CHEST, false, of(), List.of(
                Pattern.compile("^.*:chests/[a-z_]*$"),
                Pattern.compile("^.*:chests/village/[a-z_]*$")
        )));
        gameplayCategories.add(new GameplayLootCategory(Utils.modLoc("trial_chambers"), Items.TRIAL_SPAWNER, false, of(Items.TRIAL_SPAWNER, Items.TRIAL_KEY, Items.OMINOUS_TRIAL_KEY), List.of(
        ...
        gameplayCategories.add(new GameplayLootCategory(Utils.modLoc("archaeology_loot"), Items.DECORATED_POT, false, of(Items.BRUSH, Items.SUSPICIOUS_SAND, Items.SUSPICIOUS_GRAVEL), List.of(
        ...
        gameplayCategories.add(new GameplayLootCategory(Utils.modLoc("panda_sneeze"), Items.BAMBOO, false, of(Items.PANDA_SPAWN_EGG), Collections.singletonList(Pattern.compile("^.*:gameplay/panda_sneeze.*$"))));
        gameplayCategories.add(new GameplayLootCategory(Utils.modLoc("shearing"), Items.SHEARS, false, of(Items.SHEARS), Collections.singletonList(Pattern.compile("^.*:shearing/.*$"))));
        gameplayCategories.add(new GameplayLootCategory(Utils.modLoc("armadillo_shed"), Items.ARMADILLO_SCUTE, false, of(Items.ARMADILLO_SPAWN_EGG), Collections.singletonList(Pattern.compile("^.*:gameplay/armadillo_shed.*$"))));
        gameplayCategories.add(new GameplayLootCategory(Utils.modLoc("chicken_lay"), Items.EGG, false, of(Items.CHICKEN_SPAWN_EGG), Collections.singletonList(Pattern.compile("^.*:gameplay/chicken_lay.*$"))));
        gameplayCategories.add(new GameplayLootCategory(Utils.modLoc("carving"), Items.CARVED_PUMPKIN, false, of(Items.SHEARS), Collections.singletonList(Pattern.compile("^.*:carve/.*$"))));
        gameplayCategories.add(new GameplayLootCategory(Utils.modLoc("charged_creeper"), Items.CREEPER_HEAD, false, of(Items.CREEPER_SPAWN_EGG), Collections.singletonList(Pattern.compile("^.*:charged_creeper/.*$"))));
        gameplayCategories.add(new GameplayLootCategory(Utils.modLoc("harvesting"), Items.FLOWER_POT, false, of(), Collections.singletonList(Pattern.compile("^.*:harvest/.*$"))));
        gameplayCategories.add(new GameplayLootCategory(Utils.modLoc("turtle_grow"), Items.TURTLE_SCUTE, false, of(Items.TURTLE_SPAWN_EGG), Collections.singletonList(Pattern.compile("^.*:gameplay/turtle_grow.*$"))));
