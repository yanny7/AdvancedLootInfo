...
public class ConditionTooltipTest {
    ...
    public void testReferenceTooltip() {
        assertTooltip(ConditionTooltipUtils.getReferenceTooltip(UTILS, (ConditionReference) ConditionReference.conditionReference(ResourceKey.create(Registries.PREDICATE, new ResourceLocation("test"))).build()), List.of("Reference: minecraft:test"));
    }
    ...
    public void testTableBonusTooltip() {
        assertTooltip(ConditionTooltipUtils.getTableBonusTooltip(UTILS, (BonusLevelTableCondition) BonusLevelTableCondition.bonusLevelFlatChance(Enchantments.LOOTING, 0.25F, 0.5555F, 0.99F).build()), List.of(
                "Table Bonus:",
