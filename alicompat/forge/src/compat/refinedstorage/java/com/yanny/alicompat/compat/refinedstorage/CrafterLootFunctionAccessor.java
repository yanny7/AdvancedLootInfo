...
public class CrafterLootFunctionAccessor extends ConditionalFunction implements IFunctionTooltip {
    public CrafterLootFunctionAccessor(LootItemConditionalFunction conditionalFunction) {
    ...
    public TooltipBuilder getTooltip(IServerUtils utils) {
        return TooltipBuilder.array((b) -> {
            ...
            b.showEmpty();
        }, RefinedStorageLang.Functions.COPY_CRAFTER_NAME);
    }
}
