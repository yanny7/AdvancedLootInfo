...
public class DropContainerLootAccessor extends ConditionalFunction implements IFunctionTooltip {
    public DropContainerLootAccessor(LootItemConditionalFunction conditionalFunction) {
