...
public class SpawnTNTAccessor extends ConditionalFunction implements IFunctionTooltip {
    public SpawnTNTAccessor(LootItemConditionalFunction conditionalFunction) {
    ...
    public TooltipBuilder getTooltip(IServerUtils utils) {
        return TooltipBuilder.array((b) -> {
            ...
            b.showEmpty();
        }, AetherLang.Functions.SPAWN_TNT);
    }
}
