...
public class RetexturedLootFunctionAccessor extends ConditionalFunction implements IFunctionTooltip {
    public RetexturedLootFunctionAccessor(LootItemConditionalFunction conditionalFunction) {
    ...
    public TooltipBuilder getTooltip(IServerUtils utils) {
        return TooltipBuilder.array((b) -> {
            ...
            b.showEmpty();
        }, MantleLang.Functions.RETEXTURED);
    }
}
