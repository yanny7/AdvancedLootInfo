...
public class CommonPlugin implements IPlugin {
    ...
    public void registerCommon(ICommonRegistry registry) {
        ...
        registry.registerFunction(CopyComponentsAliFunction.class, getKey(LootItemFunctions.COPY_COMPONENTS), CopyComponentsAliFunction::new, CopyComponentsAliFunction::new);
        registry.registerFunction(CopyCustomDataAliFunction.class, getKey(LootItemFunctions.COPY_CUSTOM_DATA), CopyCustomDataAliFunction::new, CopyCustomDataAliFunction::new);
        ...
        registry.registerFunction(FilteredAliFunction.class, getKey(LootItemFunctions.FILTERED), FilteredAliFunction::new, FilteredAliFunction::new);
        ...
        registry.registerFunction(ModifyContentsAliFunction.class, getKey(LootItemFunctions.MODIFY_CONTENTS), ModifyContentsAliFunction::new, ModifyContentsAliFunction::new);
        ...
        registry.registerFunction(SetBookCoverAliFunction.class, getKey(LootItemFunctions.SET_BOOK_COVER), SetBookCoverAliFunction::new, SetBookCoverAliFunction::new);
        registry.registerFunction(SetComponentsAliFunction.class, getKey(LootItemFunctions.SET_COMPONENTS), SetComponentsAliFunction::new, SetComponentsAliFunction::new);
        ...
        registry.registerFunction(SetCustomDataAliFunction.class, getKey(LootItemFunctions.SET_CUSTOM_DATA), SetCustomDataAliFunction::new, SetCustomDataAliFunction::new);
        registry.registerFunction(SetCustomModelDataAliFunction.class, getKey(LootItemFunctions.SET_CUSTOM_MODEL_DATA), SetCustomModelDataAliFunction::new, SetCustomModelDataAliFunction::new);
        ...
        registry.registerFunction(SetFireworkExplosionAliFunction.class, getKey(LootItemFunctions.SET_FIREWORK_EXPLOSION), SetFireworkExplosionAliFunction::new, SetFireworkExplosionAliFunction::new);
        registry.registerFunction(SetFireworksAliFunction.class, getKey(LootItemFunctions.SET_FIREWORKS), SetFireworksAliFunction::new, SetFireworksAliFunction::new);
        ...
        registry.registerFunction(SetItemAliFunction.class, getKey(LootItemFunctions.SET_ITEM), SetItemAliFunction::new, SetItemAliFunction::new);
        ...
        registry.registerFunction(SetOminousBottleAmplifierAliFunction.class, getKey(LootItemFunctions.SET_OMINOUS_BOTTLE_AMPLIFIER), SetOminousBottleAmplifierAliFunction::new, SetOminousBottleAmplifierAliFunction::new);
        ...
        registry.registerFunction(SetWritableBookPagesAliFunction.class, getKey(LootItemFunctions.SET_WRITABLE_BOOK_PAGES), SetWritableBookPagesAliFunction::new, SetWritableBookPagesAliFunction::new);
        registry.registerFunction(SetWrittenBookPagesAliFunction.class, getKey(LootItemFunctions.SET_WRITTEN_BOOK_PAGES), SetWrittenBookPagesAliFunction::new, SetWrittenBookPagesAliFunction::new);
        registry.registerFunction(ToggleTooltipsAliFunction.class, getKey(LootItemFunctions.TOGGLE_TOOLTIPS), ToggleTooltipsAliFunction::new, ToggleTooltipsAliFunction::new);
