...
public class Plugin implements IPlugin {
    ...
    public void registerClient(IClientRegistry registry) {
        ...
        registry.registerDataComponentPredicateTooltip(DataComponentPredicates.DAMAGE, ItemSubPredicateTooltipUtils::getItemDamagePredicateTooltip);
        registry.registerDataComponentPredicateTooltip(DataComponentPredicates.ENCHANTMENTS, ItemSubPredicateTooltipUtils::getItemEnchantmentsPredicateTooltip);
        registry.registerDataComponentPredicateTooltip(DataComponentPredicates.STORED_ENCHANTMENTS, ItemSubPredicateTooltipUtils::getItemStoredEnchantmentsPredicateTooltip);
        registry.registerDataComponentPredicateTooltip(DataComponentPredicates.POTIONS, ItemSubPredicateTooltipUtils::getItemPotionsPredicateTooltip);
        registry.registerDataComponentPredicateTooltip(DataComponentPredicates.CUSTOM_DATA, ItemSubPredicateTooltipUtils::getItemCustomDataPredicateTooltip);
        registry.registerDataComponentPredicateTooltip(DataComponentPredicates.CONTAINER, ItemSubPredicateTooltipUtils::getItemContainerPredicateTooltip);
        registry.registerDataComponentPredicateTooltip(DataComponentPredicates.BUNDLE_CONTENTS, ItemSubPredicateTooltipUtils::getItemBundlePredicateTooltip);
        registry.registerDataComponentPredicateTooltip(DataComponentPredicates.FIREWORK_EXPLOSION, ItemSubPredicateTooltipUtils::getItemFireworkExplosionPredicateTooltip);
        registry.registerDataComponentPredicateTooltip(DataComponentPredicates.FIREWORKS, ItemSubPredicateTooltipUtils::getItemFireworksPredicateTooltip);
        registry.registerDataComponentPredicateTooltip(DataComponentPredicates.WRITABLE_BOOK, ItemSubPredicateTooltipUtils::getItemWritableBookPredicateTooltip);
        registry.registerDataComponentPredicateTooltip(DataComponentPredicates.WRITTEN_BOOK, ItemSubPredicateTooltipUtils::getItemWrittenBookPredicateTooltip);
        registry.registerDataComponentPredicateTooltip(DataComponentPredicates.ATTRIBUTE_MODIFIERS, ItemSubPredicateTooltipUtils::getItemAttributeModifiersPredicateTooltip);
        registry.registerDataComponentPredicateTooltip(DataComponentPredicates.ARMOR_TRIM, ItemSubPredicateTooltipUtils::getItemTrimPredicateTooltip);
        registry.registerDataComponentPredicateTooltip(DataComponentPredicates.JUKEBOX_PLAYABLE, ItemSubPredicateTooltipUtils::getItemJukeboxPlayableTooltip);
