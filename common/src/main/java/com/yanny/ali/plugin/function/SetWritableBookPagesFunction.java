...
public class SetWritableBookPagesFunction extends LootConditionalFunction {
    public final List<Filterable<Component>> pages;
    public final String operation;

    public SetWritableBookPagesFunction(IContext context, LootItemFunction function) {
    ...
    public SetWritableBookPagesFunction(IContext context, FriendlyByteBuf buf) {
        super(context, buf);
