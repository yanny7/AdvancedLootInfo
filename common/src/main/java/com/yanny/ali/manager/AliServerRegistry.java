...
public class AliServerRegistry implements IServerRegistry, IServerUtils {
    ...
    private final ManagedRegistry<Class<?>, BiFunction<IServerUtils, SlotSource, ITooltipNode>> slotSourceTooltips = registerClassKeyed("slot source tooltips", true, HashMap::new);
    // modifiers
