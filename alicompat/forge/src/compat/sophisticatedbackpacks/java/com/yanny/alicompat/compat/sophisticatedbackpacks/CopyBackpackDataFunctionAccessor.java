...
public class CopyBackpackDataFunctionAccessor extends ConditionalFunction implements IFunctionTooltip {
    public CopyBackpackDataFunctionAccessor(LootItemConditionalFunction conditionalFunction) {
    ...
    public TooltipBuilder getTooltip(IServerUtils utils) {
        return TooltipBuilder.array((b) -> {
            ...
            b.showEmpty();
        }, SophisticatedBackpacksLang.Functions.COPY_BACKPACK_DATA);
    }
}
