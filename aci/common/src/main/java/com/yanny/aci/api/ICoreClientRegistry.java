...
public interface ICoreClientRegistry
    ...
    void registerDataNode(ResourceLocation id, BiFunction<CU, RegistryFriendlyByteBuf, DN> dataFactory);

    void registerTooltipNode(ResourceLocation id, BiFunction<CU, RegistryFriendlyByteBuf, TN> tooltipFactory);
