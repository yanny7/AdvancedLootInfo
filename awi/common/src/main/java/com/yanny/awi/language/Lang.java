...
public final class Lang {
    public enum Feature implements ITooltipKey {
        ...
        BONUS_CHEST("bonus_chest", "Bonus Chest:"),
        CHORUS_PLANT("chorus_plant", "Chorus Plant:"),
        CORAL_CLAW("coral_claw", "Coral Claw:"),
        CORAL_TREE("coral_tree", "Coral Tree:"),
        DELTA_FEATURE("delta_feature", "Delta Feature:"),
        DISK("disk", "Disk:"),
        END_GATEWAY("end_gateway", "End Gateway:"),
        END_ISLAND("end_island", "End Island:"),
        END_PLATFORM("end_platform", "End Platform:"),
        END_PODIUM("end_podium", "End Podium:"),
        END_SPIKE("end_spike", "End Spike:"),
        FALLEN_TREE("fallen_tree", "Fallen Tree:"),
        FILL_LAYER("fill_layer", "Fill Layer:"),
        FOSSIL("fossil", "Fossil:"),
        FREEZE_TOP_LAYER("freeze_top_layer", "Freeze Top Layer:"),
        GEODE("geode", "Geode:"),
        HUGE_BROWN_MUSHROOM("huge_brown_mushroom", "Huge Brown Mushroom:"),
        HUGE_FUNGUS("huge_fungus", "Huge Fungus:"),
        HUGE_RED_MUSHROOM("huge_red_mushroom", "Huge Red Mushroom:"),
        ICEBERG("iceberg", "Iceberg:"),
        LAKE("lake", "Lake:"),
        LARGE_DRIPSTONE("large_dripstone", "Large Dripstone:"),
        MONSTER_ROOM("monster_room", "Monster Room:"),
        MULTIFACE_GROWTH("multiface_growth", "Multiface Growth:"),
        NETHERRACK_REPLACE_BLOBS("netherrack_replace_blobs", "Netherrack Replace Blobs:"),
        NO_OP("no_op", "No Op:"),
        ORE("ore", "Ore:"),
        OVERLAY("overlay", "Overlay:"),
        PROJECTED_RANDOM_PATCHY_SQUARE("projected_random_patchy_square", "Projected Random Patchy Square:"),
        RANDOM_BOOLEAN_SELECTOR("random_boolean_selector", "Random Boolean Selector:"),
        RANDOM_NEIGHBOR_SPREAD("random_neighbor_spread", "Random Neighbor Spread:"),
        RANDOM_SELECTOR("random_selector", "Random Selector:"),
        REPLACE_SINGLE_BLOCK("replace_single_block", "Replace Single Block:"),
        ROOT_SYSTEM("root_system", "Root System:"),
        SCATTERED_ORE("scattered_ore", "Scattered Ore:"),
        SCULK_PATCH("sculk_patch", "Sculk Patch:"),
        SEQUENCE("sequence", "Sequence:"),
        SIMPLE_BLOCK("simple_block", "Simple Block:"),
        SIMPLE_RANDOM_SELECTOR("simple_random_selector", "Simple Random Selector:"),
        SINGLE_BLOCK_PILLAR("single_block_pillar", "Single Block Pillar:"),
        SPELEOTHEM("speleothem", "Speleothem:"),
        SPELEOTHEM_CLUSTER("speleothem_cluster", "Speleothem Cluster:"),
        SPIKE("spike", "Spike:"),
        SPRING_FEATURE("spring_feature", "Spring Feature:"),
        STEPPED_COLUMN_CLUSTER("stepped_column_cluster", "Stepped Column Cluster:"),
        TEMPLATE("template", "Template:"),
        TREE("tree", "Tree:"),
        UNDERWATER_MAGMA("underwater_magma", "Underwater Magma:"),
        VEGETATION_PATCH("vegetation_patch", "Vegetation Patch:"),
        VINES("vines", "Vines:"),
        VOID_START_PLATFORM("void_start_platform", "Void Start Platform:"),
        WATERLOGGED_VEGETATION_PATCH("waterlogged_vegetation_patch", "Waterlogged Vegetation Patch:"),
        WEIGHTED_RANDOM_SELECTOR("weighted_random_selector", "Weighted Random Selector:"),
        ;

        private final Translation translation;

        Feature(String k, String e) {
            this.translation = new Translation("awi.type.feature." + k, e);
        }
    ...
    public enum RuleTest implements ITooltipKey {
        ...
        HEIGHT_MATCH("height_match", "Height Match:"),
        NOT("not", "Not:"),
    ...
    public enum Value implements ITooltipKey {
        ...
        CHANCE_TO_CONTINUE("chance_to_continue", "Chance To Continue: %s"),
        ...
        INCLUDE_EDGES("include_edges", "Include Edges: %s"),
        INCLUDE_INTERIOR("include_interior", "Include Interior: %s"),
        INNER("inner", "Inner: %s"),
        ...
        MAX_PROJECTION_HEIGHT("max_projection_height", "Max Projection Height: %s"),
        ...
        SIDE_HOLE_CHANCE("side_hole_chance", "Side Hole Chance: %s"),
        SIZE("size", "Size: %s"),
    ...
    public enum Branch implements ITooltipKey {
        ...
        ACCEPTED_NEIGHBORS("accepted_neighbors", "Accepted Neighbors:"),
        ...
        BRANCH_AMOUNT("branch_amount", "Branch Amount:"),
        ...
        CANNOT_PLACE_ON("cannot_place_on", "Cannot Place On:"),
        ...
        CAP_FEATURE("cap_feature", "Cap Feature:"),
        CAP_PROVIDER("cap_provider", "Cap Provider:"),
        CLUSTER_REACH("cluster_reach", "Cluster Reach:"),
        COLUMN_COUNT("column_count", "Column Count:"),
        COLUMN_RADIUS("column_radius", "Column Radius:"),
        COLUMN_REACH("column_reach", "Column Reach:"),
        CONTENTS("contents", "Contents:"),
        CONTINUE_THROUGH("continue_through", "Continue Through:"),
        COUNT("count", "Count:"),
        ...
        PROJECT_THROUGH("project_through", "Project Through:"),
        ...
        TRUNK_HEIGHT_ABOVE_BRANCHES("trunk_height_above_branches", "Trunk Height Above Branches:"),
        ...
        X("x", "X:"),
        XZ_OFFSET("xz_offset", "XZ Offset:"),
        XZ_RADIUS("xz_radius", "XZ Radius:"),
        XZ_SIZE("xz_size", "XZ Size:"),
        Y("y", "Y:"),
        Y_OFFSET("y_offset", "Y Offset:"),
        Y_SIZE("y_size", "Y Size:"),
        Z("z", "Z:"),
        ;
    ...
    public enum TreeDecorator implements ITooltipKey {
        ...
        SHELF_MUSHROOM("shelf_mushroom", "Shelf Mushroom:"),
        ;
    ...
    public enum PlacementModifier implements ITooltipKey {
        ...
        OFFSET("offset", "Offset:"),
        RANDOMLY_SELECTED("randomly_selected", "Randomly Selected:"),
    ...
    public enum BlockPredicate implements ITooltipKey {
        ...
        HEIGHT_RANGE("height_range", "Height Range:"),
        ...
        VOLUME_MATCH("volume_match", "Volume Match:"),
