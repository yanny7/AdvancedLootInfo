...
public class GenericTooltipUtils {
    ...
    public static List<Component> getBlockPredicateTooltip(IClientUtils utils, int pad, String key, BlockPredicate blockPredicate) {
        ...
        if (blockPredicate != BlockPredicate.ANY) {
            ...
            components.addAll(getOptionalCollectionTooltip(utils, pad + 1, "ali.property.branch.blocks", "ali.property.value.null", blockPredicate.blocks, RegistriesTooltipUtils::getBlockTooltip));
    ...
    public static List<Component> getNbtPredicateTooltip(IClientUtils utils, int pad, String key, NbtPredicate nbtPredicate) {
        ...
        if (nbtPredicate != NbtPredicate.ANY) {
            components.addAll(getOptionalTooltip(utils, pad, key, nbtPredicate.tag, GenericTooltipUtils::getCompoundTagTooltip));
        }
    ...
    public static List<Component> getMobEffectPredicateTooltip(IClientUtils utils, int pad, String key, MobEffectsPredicate mobEffectsPredicate) {
        ...
        if (mobEffectsPredicate != MobEffectsPredicate.ANY) {
            components.addAll(getMapTooltip(utils, pad, key, mobEffectsPredicate.effects, GenericTooltipUtils::getMobEffectPredicateEntryTooltip));
        }
    ...
    public static List<Component> getItemPredicateTooltip(IClientUtils utils, int pad, String key, ItemPredicate itemPredicate) {
        ...
        if (itemPredicate != ItemPredicate.ANY) {
            ...
            components.addAll(getOptionalCollectionTooltip(utils, pad + 1, "ali.property.branch.items", "ali.property.value.null", itemPredicate.items, RegistriesTooltipUtils::getItemTooltip));
    ...
    @NotNull
    public static <T> List<Component> getOptionalCollectionTooltip(IClientUtils utils, int pad, String key, String value, @Nullable Collection<T> values, QuadFunction<IClientUtils, Integer, String, T, List<Component>> mapper) {
        List<Component> components = new LinkedList<>();
    ...
    @NotNull
    public static List<Component> getMobEffectPredicateEntryTooltip(IClientUtils utils, int pad, Map.Entry<MobEffect, MobEffectsPredicate.MobEffectInstancePredicate> entry) {
        List<Component> components = new LinkedList<>();

        components.addAll(getMobEffectTooltip(utils, pad, "ali.property.value.null", entry.getKey()));
    ...
    @NotNull
    public static List<Component> getEnchantmentLevelsEntryTooltip(IClientUtils utils, int pad, Map.Entry<Enchantment, NumberProvider> entry) {
        List<Component> components = new LinkedList<>();

        components.addAll(getEnchantmentTooltip(utils, pad, "ali.property.value.null", entry.getKey()));
    ...
    @NotNull
    public static List<Component> getMobEffectDurationEntryTooltip(IClientUtils utils, int pad, Map.Entry<MobEffect, NumberProvider> entry) {
        List<Component> components = new LinkedList<>();

        components.addAll(getMobEffectTooltip(utils, pad, "ali.property.value.null", entry.getKey()));
        components.addAll(getNumberProviderTooltip(utils, pad + 1, "ali.property.value.duration", entry.getValue()));
