...
public class SpawnXPAccessor extends ConditionalFunction implements IFunctionTooltip {
    public SpawnXPAccessor(LootItemConditionalFunction conditionalFunction) {
