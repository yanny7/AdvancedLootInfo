...
final class LootContextProbe {
    ...
    static Verdict probe(IServerUtils utils, LootItemCondition condition, LootPage page, List<ILootContextPreparer> preparers, HolderGetter.Provider lootData) {
        try {
            ...
            LootContext context = new LootContext(new LootParams(null, new ContextMap(new ParamMap(page)), Map.of(), 0F), TrapRandom.INSTANCE, lootData);
    ...
    private static final class ParamMap extends AbstractMap<ContextKey<?>, Object> {
        ...
        public boolean containsKey(Object key) {
            return switch (GlobalLootModifierUtils.getParamState(page, (ContextKey<?>) key)) {
        ...
        public Object get(Object key) {
            if (GlobalLootModifierUtils.getParamState(page, (ContextKey<?>) key) == ParamState.DISALLOWED) {
                return null;
            }
        ...
        @NotNull
        @Override
        public Set<Entry<ContextKey<?>, Object>> entrySet() {
            throw TRAP;
        }
    }
