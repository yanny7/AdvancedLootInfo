...
public abstract class CoreClientRegistry
    ...
    private final ManagedRegistry<Identifier, IWidgetFactory<SU, TN, DN, WU>> widgetMap = register("node widgets", false, HashMap::new, Identifier::toString, null);
    private final ManagedRegistry<Identifier, BiFunction<CU, RegistryFriendlyByteBuf, DN>> dataNodeFactoryMap = register("data node factories", false, HashMap::new, Identifier::toString, null);
    private final ManagedRegistry<Identifier, BiFunction<CU, RegistryFriendlyByteBuf, TN>> tooltipNodeFactoryMap = register("tooltip node factories", false, HashMap::new, Identifier::toString, null);
    ...
    @Override
    public final void registerWidget(Identifier id, IWidgetFactory<SU, TN, DN, WU> factory) {
        widgetMap.put(id, factory);
    }

    @Override
    public final void registerDataNode(Identifier id, BiFunction<CU, RegistryFriendlyByteBuf, DN> dataFactory) {
        dataNodeFactoryMap.put(id, dataFactory);
    }

    @Override
    public final void registerTooltipNode(Identifier id, BiFunction<CU, RegistryFriendlyByteBuf, TN> tooltipFactory) {
    ...
    @NotNull
    @Override
    public final BiFunction<CU, RegistryFriendlyByteBuf, DN> getDataNodeFactory(Identifier id) {
    ...
    @NotNull
    @Override
    public final BiFunction<CU, RegistryFriendlyByteBuf, TN> getTooltipNodeFactory(Identifier id) {
