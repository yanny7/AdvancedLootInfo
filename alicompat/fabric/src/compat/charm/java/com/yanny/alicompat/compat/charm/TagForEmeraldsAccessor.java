...
public class TagForEmeraldsAccessor extends BaseAccessor<GenericTradeOffers.TagForEmeralds<?>> implements IItemListing {
    @FieldAccessor
    ...
    public TagForEmeraldsAccessor(GenericTradeOffers.TagForEmeralds<?> parent) {
        super(parent);
    }
