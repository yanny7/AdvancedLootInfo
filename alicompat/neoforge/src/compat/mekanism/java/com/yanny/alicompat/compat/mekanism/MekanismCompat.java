...
public class MekanismCompat implements IModCompat {
    ...
    public void registerServer(IServerRegistry registry) {
        ...
        registry.registerItemSubPredicateTooltip(FullCanteenItemPredicate.class, MekanismCompat::fullCanteenItemPredicateTooltip);
        PluginUtils.registerItemSubPredicateTooltip(registry, MaxedModuleContainerItemPredicate.class, MaxedModuleContainerItemPredicateAccessor.class);
    }
    ...
    private static TooltipBuilder fullCanteenItemPredicateTooltip(IServerUtils utils, FullCanteenItemPredicate predicate) {
        return TooltipBuilder.keyOnly(MekanismLang.ItemSubPredicates.FULL_CANTEEN);
    }
}
