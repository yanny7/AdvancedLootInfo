...
public class DoubleDropsAccessor extends ConditionalFunction implements IFunctionTooltip {
    public DoubleDropsAccessor(LootItemConditionalFunction conditionalFunction) {
    ...
    public TooltipBuilder getTooltip(IServerUtils utils) {
        return TooltipBuilder.array((b) -> {
            ...
            b.showEmpty();
        }, AetherLang.Functions.DOUBLE_DROPS);
    }
}
