        ...
        if (level != null) {
            ...
            for (Block block : BuiltInRegistries.BLOCK) {
                ...
                if (lootEntry != null) {
                    ...
                    registry.addRecipe(new EmiBlockLoot(category, new ResourceLocation(location.location().getNamespace(), "/" + location.location().getPath()), block, lootEntry, clientRegistry.getLootItems(location)));
                ...
                entityList.forEach((entity) -> {
                    if (entity instanceof Mob mob) {
                        ...
                        if (lootEntry != null) {
                            ...
                            registry.addRecipe(new EmiEntityLoot(category, new ResourceLocation(location.location().getNamespace(), "/" + location.location().getPath()), entity, lootEntry, clientRegistry.getLootItems(location)));
                            lootData.remove(location);
                        }
                    }
                });
            ...
            for (Map.Entry<ResourceKey<LootTable>, IDataNode> entry : lootData.entrySet()) {
                ...
                registry.addRecipe(new EmiGameplayLoot(category, new ResourceLocation(location.location().getNamespace(), "/" + location.location().getPath()), entry.getValue(), clientRegistry.getLootItems(location)));
            }
