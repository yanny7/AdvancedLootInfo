...
public final class Lang {
    public enum Conditions implements ITooltipKey {
        ...
        ENVIRONMENT_ATTRIBUTE_CHECK("environment_attribute_check", "Environment Attribute Check:"),
        FLOAT_VALUE_CHECK("float_value_check", "Float Value Check:"),
        INT_VALUE_CHECK("int_value_check", "Int Value Check:"),
        INVERTED("inverted", "Inverted:"),
        KILLED_BY_PLAYER("killed_by_player", "Killed by player"),
        LOCATION_CHECK("location_check", "Location Check:"),
        MATCH_BLOCK("match_block", "Match Block:"),
    ...
    public enum Functions implements ITooltipKey {
        ...
        SET_RANDOM_DYES("set_random_dyes", "Set Random Dyes:"),
        SET_RANDOM_POTIONS("set_random_potions", "Set Random Potions:"),
    ...
    public enum Value implements ITooltipKey {
        ...
        BURN_TIME("burn_time", "Burn Time: %s"),
        ...
        DAMAGE_TYPE("damage_type", "Damage Type: %s"),
        ...
        DIRECTIONAL_PARTICLES("directional_particles", "Directional Particles: %s"),
        ...
        HAS_GLOWING_TEXT("has_glowing_text", "Has Glowing Text: %s"),
        HAS_RAID("has_raid", "Has Raid: %s"),
        HAS_TRAIL("has_trail", "Has Trail: %s"),
        HAS_TWINKLE("has_twinkle", "Has Twinkle: %s"),
        HIDDEN_COMPONENT("hidden_component", "Hidden Component: %s"),
        ...
        STORED_ENCHANTMENT("stored_enchantment", "Stored Enchantment: %s"),
        ...
        VISIBILITY("visibility", "Visibility: %s"),
    ...
    public enum Branch implements ITooltipKey {
        ...
        DESTINATION(Value.DESTINATION, "destination", "Destination:"),
        ...
        FILTERED_MESSAGES("filtered_messages", "Filtered Messages:"),
        FILTERS("filters", "Filters:"),
        FIREWORK("firework", "Firework:"),
        FIREWORK_EXPLOSION("firework_explosion", "Firework Explosion:"),
        FLAGS("flags", "Flags:"),
        ...
        HEAD("head", "Head:"),
        HIDDEN_COMPONENTS(Value.HIDDEN_COMPONENT, "hidden_components", "Hidden Components:"),
        ...
        PREDICATE(Value.PREDICATE, "predicate", "Predicate:"),
        ...
        STORED_ENCHANTMENTS(Value.STORED_ENCHANTMENT, "stored_enchantments", "Stored Enchantments:"),
