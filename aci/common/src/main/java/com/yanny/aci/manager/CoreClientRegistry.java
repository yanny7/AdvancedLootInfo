...
public abstract class CoreClientRegistry
    ...
    private final ManagedRegistry<ResourceLocation, BiFunction<CU, FriendlyByteBuf, DN>> dataNodeFactoryMap = register("data node factories", false, HashMap::new, ResourceLocation::toString, null);
    private final ManagedRegistry<ResourceLocation, BiFunction<CU, FriendlyByteBuf, TN>> tooltipNodeFactoryMap = register("tooltip node factories", false, HashMap::new, ResourceLocation::toString, null);
    ...
    @Override
    public final void registerDataNode(ResourceLocation id, BiFunction<CU, FriendlyByteBuf, DN> dataFactory) {
        dataNodeFactoryMap.put(id, dataFactory);
    }

    @Override
    public final void registerTooltipNode(ResourceLocation id, BiFunction<CU, FriendlyByteBuf, TN> tooltipFactory) {
    ...
    @NotNull
    @Override
    public final BiFunction<CU, FriendlyByteBuf, DN> getDataNodeFactory(ResourceLocation id) {
        Optional<BiFunction<CU, FriendlyByteBuf, DN>> dataFactory = dataNodeFactoryMap.get(id);
    ...
    @NotNull
    @Override
    public final BiFunction<CU, FriendlyByteBuf, TN> getTooltipNodeFactory(ResourceLocation id) {
        Optional<BiFunction<CU, FriendlyByteBuf, TN>> tooltipFactory = tooltipNodeFactoryMap.get(id);
