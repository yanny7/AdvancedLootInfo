...
public class ItemsForEmeraldsNode extends ListNode {
    ...
    public ItemsForEmeraldsNode(IServerUtils utils, VillagerTrades.ItemsForEmeralds listing, List<ITooltipNode> conditions) {
        ...
        addChildren(new ItemStackNode(utils, listing.itemStack, new RangeValue(listing.numberOfItems)));
