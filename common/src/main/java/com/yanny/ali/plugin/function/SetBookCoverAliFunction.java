...
public class SetBookCoverAliFunction extends LootConditionalAliFunction {
    ...
    public SetBookCoverAliFunction(IContext context, LootItemFunction function) {
    ...
    public SetBookCoverAliFunction(IContext context, FriendlyByteBuf buf) {
        super(context, buf);
