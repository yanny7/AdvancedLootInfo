...
public abstract class CoreClientRegistry<
    ...
    private final ManagedRegistry<ResourceLocation, BiFunction<TClientUtils, FriendlyByteBuf, TTooltipNode>> tooltipNodeFactoryMap = register("tooltip node factories", false, HashMap::new, ResourceLocation::toString, null);
    ...
    @Override
    public final void registerTooltipNode(ResourceLocation id, BiFunction<TClientUtils, FriendlyByteBuf, TTooltipNode> tooltipFactory) {
    ...
    @NotNull
    @Override
    public final BiFunction<TClientUtils, FriendlyByteBuf, TTooltipNode> getTooltipNodeFactory(ResourceLocation id) {
        Optional<BiFunction<TClientUtils, FriendlyByteBuf, TTooltipNode>> tooltipFactory = tooltipNodeFactoryMap.get(id);
