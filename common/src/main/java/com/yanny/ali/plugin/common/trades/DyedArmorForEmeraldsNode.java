...
public class DyedArmorForEmeraldsNode extends ListNode {
    public static final ResourceLocation ID = new ResourceLocation(Utils.MOD_ID, "dyed_armor_for_emeralds");
    ...
    public DyedArmorForEmeraldsNode(IClientUtils utils, FriendlyByteBuf buf) {
        super(utils, buf);
