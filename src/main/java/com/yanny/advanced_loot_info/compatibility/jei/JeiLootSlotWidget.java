...
public class JeiLootSlotWidget implements ISlottedRecipeWidget {
    ...
    public JeiLootSlotWidget(SingletonEntry entry, IRecipeSlotDrawable slotDrawable, int x, int y, RangeValue chance, @Nullable Pair<Enchantment, Map<Integer, RangeValue>> bonusChance,
