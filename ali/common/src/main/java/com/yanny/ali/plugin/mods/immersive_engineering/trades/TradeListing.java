...
public class TradeListing extends BaseAccessor<VillagerTrades.ItemListing> implements IItemListing {
    ...
    static {
        ...
        try {
            ...
            LOGGER.warn("Unable to obtain trade outline SELL_FOR_MANY_EMERALDS: {}", e.getMessage(), e);
        }
        ...
        try {
            ...
            LOGGER.warn("Unable to obtain trade outline BUY_FOR_ONE_EMERALD: {}", e.getMessage(), e);
        }
        ...
        try {
            ...
            LOGGER.warn("Unable to obtain trade outline BUY_FOR_MANY_EMERALDS: {}", e.getMessage(), e);
        }
