...
public class BaseLayoutTestUtils {
    ...
    public static BaseLayoutScanner scanner(long seed, NodeUtils.ScanSettings settings, boolean logStatistics) {
        ...
        return BaseLayoutScanner.scan(registryAccess, PalettedContainerFactory.create(registryAccess), lookup, seed, levelStems, (dimension) -> true, SURFACE_RULE_HANDLERS, settings, logStatistics);
    }
