...
public class UniquifyIfHasItemsAccessor extends ConditionalFunction implements IFunctionTooltip {
    public UniquifyIfHasItemsAccessor(LootItemConditionalFunction conditionalFunction) {
    ...
    public TooltipBuilder getTooltip(IServerUtils utils) {
        return TooltipBuilder.array((b) -> {
            ...
            b.showEmpty();
        }, BumblezoneLang.Functions.UNIQUIFY_IF_HAS_ITEMS);
    }
}
