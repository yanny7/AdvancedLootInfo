...
public class EntryTooltipTest {
    ...
    public void testDynamicTooltip() {
        assertTooltip(EntryTooltipUtils.getDynamicTooltip(UTILS, (DynamicLoot) DynamicLoot.dynamicEntry(ResourceLocation.withDefaultNamespace("test")).setWeight(3).setQuality(10).build(), 0.3f, 3), List.of(
