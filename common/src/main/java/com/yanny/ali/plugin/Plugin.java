...
public class Plugin implements IPlugin {
    ...
    public void registerClient(IClientRegistry registry) {
        ...
        registry.registerItemSubPredicateTooltip(DataComponentPredicates.DAMAGE, ItemSubPredicateTooltipUtils::getItemDamagePredicateTooltip);
        registry.registerItemSubPredicateTooltip(DataComponentPredicates.ENCHANTMENTS, ItemSubPredicateTooltipUtils::getItemEnchantmentsPredicateTooltip);
        registry.registerItemSubPredicateTooltip(DataComponentPredicates.STORED_ENCHANTMENTS, ItemSubPredicateTooltipUtils::getItemStoredEnchantmentsPredicateTooltip);
        registry.registerItemSubPredicateTooltip(DataComponentPredicates.POTIONS, ItemSubPredicateTooltipUtils::getItemPotionsPredicateTooltip);
        registry.registerItemSubPredicateTooltip(DataComponentPredicates.CUSTOM_DATA, ItemSubPredicateTooltipUtils::getItemCustomDataPredicateTooltip);
        registry.registerItemSubPredicateTooltip(DataComponentPredicates.CONTAINER, ItemSubPredicateTooltipUtils::getItemContainerPredicateTooltip);
        registry.registerItemSubPredicateTooltip(DataComponentPredicates.BUNDLE_CONTENTS, ItemSubPredicateTooltipUtils::getItemBundlePredicateTooltip);
        registry.registerItemSubPredicateTooltip(DataComponentPredicates.FIREWORK_EXPLOSION, ItemSubPredicateTooltipUtils::getItemFireworkExplosionPredicateTooltip);
        registry.registerItemSubPredicateTooltip(DataComponentPredicates.FIREWORKS, ItemSubPredicateTooltipUtils::getItemFireworksPredicateTooltip);
        registry.registerItemSubPredicateTooltip(DataComponentPredicates.WRITABLE_BOOK, ItemSubPredicateTooltipUtils::getItemWritableBookPredicateTooltip);
        registry.registerItemSubPredicateTooltip(DataComponentPredicates.WRITTEN_BOOK, ItemSubPredicateTooltipUtils::getItemWrittenBookPredicateTooltip);
        registry.registerItemSubPredicateTooltip(DataComponentPredicates.ATTRIBUTE_MODIFIERS, ItemSubPredicateTooltipUtils::getItemAttributeModifiersPredicateTooltip);
        registry.registerItemSubPredicateTooltip(DataComponentPredicates.ARMOR_TRIM, ItemSubPredicateTooltipUtils::getItemTrimPredicateTooltip);
        registry.registerItemSubPredicateTooltip(DataComponentPredicates.JUKEBOX_PLAYABLE, ItemSubPredicateTooltipUtils::getItemJukeboxPlayableTooltip);
