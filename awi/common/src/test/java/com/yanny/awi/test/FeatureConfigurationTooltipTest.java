...
public class FeatureConfigurationTooltipTest {
    ...
    public void testRandomPatchConfigurationTooltip() {
        ...
        assertTooltip(FeatureConfigurationTooltipUtils.getRandomPatchConfigurationTooltip(UTILS, new RandomPatchConfiguration(64, 5, 2, placedFeatureWithPlacement)).build(), List.of(
                "Random Patch:",
                "  -> Tries: 64",
                "  -> XZ Spread: 5",
                "  -> Y Spread: 2",
