...
public class ConfigItemPoolEntryAccessor extends BaseAccessor<ConfigItemPoolEntry> implements IEntry, IEntryTooltip {
    @FieldAccessor
    private Item item;

    @FieldAccessor
    private String tagOrItemId;

    public ConfigItemPoolEntryAccessor(ConfigItemPoolEntry parent) {
        super(parent);
    }
    ...
    public TooltipBuilder getTooltip(IServerUtils utils) {
        return TooltipBuilder.array((b) -> {
            ...
            b.add(utils.getValueTooltip(utils, tagOrItemId).build(Lang.Value.NAME));
        ...
        }, MoonlightLang.Entry.CONFIG_ITEM);
    }
