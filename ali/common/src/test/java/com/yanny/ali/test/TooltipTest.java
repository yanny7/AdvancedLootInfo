...
public class TooltipTest {
    ...
    public void testChanceTooltip() {
        ...
        assertTooltip(getChanceTooltip(getEnchantedChance(UTILS, List.of(BonusLevelTableCondition.bonusLevelFlatChance(Enchantments.BLOCK_FORTUNE, 0.1f, 0.2f, 0.3f, 0.4f).build()), 1)), List.of(
                "Chance: 10%",
                "  -> 20% (Fortune I)",
                "  -> 30% (Fortune II)",
                "  -> 40% (Fortune III)"
        ));
        assertTooltip(getChanceTooltip(getEnchantedChance(UTILS, List.of(BonusLevelTableCondition.bonusLevelFlatChance(Enchantments.BLOCK_FORTUNE, 0.1f, 0.2f, 0.3f, 0.4f).build()), 0.5f)), List.of(
                "Chance: 5%",
                "  -> 10% (Fortune I)",
                "  -> 15% (Fortune II)",
                "  -> 20% (Fortune III)"
    ...
    public void testCountTooltip() {
        ...
        assertTooltip(getCountTooltip(getEnchantedCount(UTILS, List.of(ApplyBonusCount.addOreBonusCount(Enchantments.BLOCK_FORTUNE).build()))), List.of(
                "Count: 1",
                "  -> 1-2 (Fortune I)",
                "  -> 1-3 (Fortune II)",
                "  -> 1-4 (Fortune III)"
        ));
        assertTooltip(getCountTooltip(getEnchantedCount(UTILS, List.of(ApplyBonusCount.addUniformBonusCount(Enchantments.BLOCK_FORTUNE).build()))), List.of(
                "Count: 1",
                "  -> 1-2 (Fortune I)",
                "  -> 1-3 (Fortune II)",
                "  -> 1-4 (Fortune III)"
        ));
        assertTooltip(getCountTooltip(getEnchantedCount(UTILS, List.of(ApplyBonusCount.addUniformBonusCount(Enchantments.BLOCK_FORTUNE, 2).build()))), List.of(
                "Count: 1",
                "  -> 1-3 (Fortune I)",
                "  -> 1-5 (Fortune II)",
                "  -> 1-7 (Fortune III)"
        ));
        assertTooltip(getCountTooltip(getEnchantedCount(UTILS, List.of(ApplyBonusCount.addBonusBinomialDistributionCount(Enchantments.BLOCK_FORTUNE, 0.5f, 3).build()))), List.of(
                "Count: 1-4",
                "  -> 1-5 (Fortune I)",
                "  -> 1-6 (Fortune II)",
                "  -> 1-7 (Fortune III)"
