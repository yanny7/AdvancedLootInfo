...
public class LootCategories {
    ...
    public static IdentifiableResourceReloadListener onResourceReload() {
        return new JsonResourceReloadListener(GSON, "loot_categories");
    }
    ...
    private static class JsonResourceReloadListener implements IdentifiableResourceReloadListener {
        private final String id;
        private final SimpleJsonResourceReloadListener listener;

        public JsonResourceReloadListener(Gson gson, String id) {
            this.id = id;
            listener = new SimpleJsonResourceReloadListener(gson, id) {
                @Override
