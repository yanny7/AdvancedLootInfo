...
public class FarlandersCompat implements IModCompat {
    ...
    public void registerServer(IServerRegistry registry) {
        ...
        registry.registerTrades(new ResourceLocation(MOD_ID, "farlander"), () -> FarlanderTrades.FARLANDER_TRADES, (level) -> 2);
        registry.registerTrades(new ResourceLocation(MOD_ID, "elder_farlander"), () -> FarlanderTrades.ELDER_TRADES, (level) -> 2);
        registry.registerTrades(new ResourceLocation(MOD_ID, "wanderer"), () -> FarlanderTrades.WANDERER_TRADES, (level) -> 5);
    }
}
