...
public class SophisticatedStorageLang implements ICompatTranslations {
    static final String MOD_ID = "sophisticatedstorage";

    public static final Map<String, String> TRANSLATION_MAP = new HashMap<>();

    public enum Functions implements ITooltipKey {
        COPY_STORAGE_DATA("copy_storage_data", "Copy Storage Data:"),
        ;
