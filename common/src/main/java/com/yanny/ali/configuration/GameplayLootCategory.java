...
public class GameplayLootCategory extends LootCategory<Identifier> {
    ...
    public GameplayLootCategory(Identifier key, Item icon, boolean hide, List<Pattern> patterns) {
        super(key, icon, Type.GAMEPLAY, hide);
        this.patterns = patterns;
    }

    public GameplayLootCategory(JsonObject object) {
        super(Type.GAMEPLAY, object);
