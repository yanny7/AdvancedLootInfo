...
public class EntryTooltipTest {
    ...
    public void testDynamicTooltip() {
        assertTooltip(EntryTooltipUtils.getDynamicTooltip((DynamicLoot) DynamicLoot.dynamicEntry(ResourceLocation.withDefaultNamespace("test")).setWeight(3).setQuality(10).build(), 10), List.of(
