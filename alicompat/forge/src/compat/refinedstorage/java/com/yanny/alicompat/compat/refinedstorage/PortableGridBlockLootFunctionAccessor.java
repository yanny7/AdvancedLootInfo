...
public class PortableGridBlockLootFunctionAccessor extends ConditionalFunction implements IFunctionTooltip {
    public PortableGridBlockLootFunctionAccessor(LootItemConditionalFunction conditionalFunction) {
    ...
    public TooltipBuilder getTooltip(IServerUtils utils) {
        return TooltipBuilder.array((b) -> {
            ...
            b.showEmpty();
        }, RefinedStorageLang.Functions.COPY_PORTABLE_GRID_DATA);
    }
}
