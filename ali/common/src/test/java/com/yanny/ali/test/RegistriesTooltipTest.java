...
public class RegistriesTooltipTest {
    ...
    public void testLootNbtProviderTypeTooltip() {
        assertTooltip(RegistriesTooltipUtils.getLootNbtProviderTypeTooltip(UTILS, NbtProviders.CONTEXT).build(Lang.Value.NBT), List.of("Nbt: minecraft:context"));
    }
    ...
    public void testAttributeTooltip() {
        assertTooltip(RegistriesTooltipUtils.getAttributeTooltip(UTILS, Attributes.JUMP_STRENGTH.value()).build(Lang.Value.ATTRIBUTE), List.of("Attribute: minecraft:generic.jump_strength"));
    }
    ...
    public void testEntitySubPredicateTooltip() {
        assertTooltip(RegistriesTooltipUtils.getEntitySubPredicateTooltip(UTILS, EntitySubPredicates.catVariant(LOOKUP.lookupOrThrow(Registries.CAT_VARIANT).getOrThrow(CatVariant.CALICO))).build(Lang.Value.VARIANT), List.of("Variant: minecraft:cat"));
    }

    @Test
    public void testCatVariantTooltip() {
        assertTooltip(RegistriesTooltipUtils.getCatVariantTooltip(UTILS, LOOKUP.lookupOrThrow(Registries.CAT_VARIANT).getOrThrow(CatVariant.CALICO).value()).build(Lang.Value.VARIANT), List.of("Variant: minecraft:calico"));
    }
    ...
    assertTooltip(RegistriesTooltipUtils.getFrogVariantTooltip(UTILS, LOOKUP.lookupOrThrow(Registries.FROG_VARIANT).getOrThrow(FrogVariant.TEMPERATE).value()).build(Lang.Value.VARIANT), List.of("Variant: minecraft:temperate"));
    }
