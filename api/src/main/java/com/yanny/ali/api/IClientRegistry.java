...
public interface IClientRegistry {
    ...
    <T extends DataComponentPredicate> void registerDataComponentPredicateTooltip(DataComponentPredicate.Type<T> type, TriFunction<IClientUtils, Integer, T, List<Component>> getter);
    ...
    <T extends ConsumeEffect> void registerConsumeEffectTooltip(ConsumeEffect.Type<T> type, TriFunction<IClientUtils, Integer, T, List<Component>> getter);
