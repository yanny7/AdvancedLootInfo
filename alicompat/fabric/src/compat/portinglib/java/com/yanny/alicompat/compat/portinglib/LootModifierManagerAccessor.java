...
public class LootModifierManagerAccessor {
    ...
    public static Map<ResourceLocation, IGlobalLootModifier> getAllLootMods() {
        try {
            //noinspection unchecked
            return (Map<ResourceLocation, IGlobalLootModifier>) REGISTERED_GLM.get(LootModifierManager.INSTANCE);
        } catch (Throwable e) {
