...
public class TooltipTest {
    ...
    public void testChanceTooltip() {
        ...
        assertTooltip(getChanceTooltip(getEnchantedChance(UTILS, List.of(LootItemRandomChanceWithLootingCondition.randomChanceAndLootingBoost(0.1f, 0.2f).build()), 1)), List.of(
                "Chance: 10%",
                "  -> 30% (Looting I)",
                "  -> 50% (Looting II)",
                "  -> 70% (Looting III)"
        ));
        assertTooltip(getChanceTooltip(getEnchantedChance(UTILS, List.of(LootItemRandomChanceWithLootingCondition.randomChanceAndLootingBoost(0.1f, 0.2f).build()), 0.5f)), List.of(
                "Chance: 5%",
                "  -> 15% (Looting I)",
                "  -> 25% (Looting II)",
                "  -> 35% (Looting III)"
        ...
        assertTooltip(getChanceTooltip(getEnchantedChance(UTILS, List.of(BonusLevelTableCondition.bonusLevelFlatChance(Enchantments.FORTUNE, 0.1f, 0.2f, 0.3f, 0.4f).build()), 1)), List.of(
                "Chance: 10%",
                "  -> 20% (Fortune I)",
                "  -> 30% (Fortune II)",
                "  -> 40% (Fortune III)"
        ));
        assertTooltip(getChanceTooltip(getEnchantedChance(UTILS, List.of(BonusLevelTableCondition.bonusLevelFlatChance(Enchantments.FORTUNE, 0.1f, 0.2f, 0.3f, 0.4f).build()), 0.5f)), List.of(
                "Chance: 5%",
                "  -> 10% (Fortune I)",
                "  -> 15% (Fortune II)",
                "  -> 20% (Fortune III)"
    ...
    public void testCountTooltip() {
        ...
        assertTooltip(getCountTooltip(getEnchantedCount(UTILS, List.of(ApplyBonusCount.addOreBonusCount(Enchantments.FORTUNE).build()))), List.of(
                "Count: 1",
                "  -> 1-2 (Fortune I)",
                "  -> 1-3 (Fortune II)",
                "  -> 1-4 (Fortune III)"
        ));
        assertTooltip(getCountTooltip(getEnchantedCount(UTILS, List.of(ApplyBonusCount.addUniformBonusCount(Enchantments.FORTUNE).build()))), List.of(
                "Count: 1",
                "  -> 1-2 (Fortune I)",
                "  -> 1-3 (Fortune II)",
                "  -> 1-4 (Fortune III)"
        ));
        assertTooltip(getCountTooltip(getEnchantedCount(UTILS, List.of(ApplyBonusCount.addUniformBonusCount(Enchantments.FORTUNE, 2).build()))), List.of(
                "Count: 1",
                "  -> 1-3 (Fortune I)",
                "  -> 1-5 (Fortune II)",
                "  -> 1-7 (Fortune III)"
        ));
        assertTooltip(getCountTooltip(getEnchantedCount(UTILS, List.of(ApplyBonusCount.addBonusBinomialDistributionCount(Enchantments.FORTUNE, 0.5f, 3).build()))), List.of(
                "Count: 1-4",
                "  -> 1-5 (Fortune I)",
                "  -> 1-6 (Fortune II)",
                "  -> 1-7 (Fortune III)"
        ...
        assertTooltip(getCountTooltip(getEnchantedCount(UTILS, List.of(
                ApplyBonusCount.addUniformBonusCount(Enchantments.FORTUNE, 2).build(),
        ...
        assertTooltip(getCountTooltip(getEnchantedCount(UTILS, List.of(LootingEnchantFunction.lootingMultiplier(ConstantValue.exactly(2)).build()))), List.of(
                "Count: 1",
                "  -> 3 (Looting I)",
                "  -> 5 (Looting II)",
                "  -> 7 (Looting III)"
        ));
        assertTooltip(getCountTooltip(getEnchantedCount(UTILS, List.of(LootingEnchantFunction.lootingMultiplier(BinomialDistributionGenerator.binomial(3, 0.5f)).build()))), List.of(
                "Count: 1",
                "  -> 1-4 (Looting I)",
                "  -> 1-7 (Looting II)",
                "  -> 1-10 (Looting III)"
        ));
        assertTooltip(getCountTooltip(getEnchantedCount(UTILS, List.of(LootingEnchantFunction.lootingMultiplier(UniformGenerator.between(1, 4)).build()))), List.of(
                "Count: 1",
                "  -> 2-5 (Looting I)",
                "  -> 3-9 (Looting II)",
                "  -> 4-13 (Looting III)"
        ));
        assertTooltip(getCountTooltip(getEnchantedCount(UTILS, List.of(LootingEnchantFunction.lootingMultiplier(UniformGenerator.between(1, 4)).setLimit(12).build()))), List.of(
                "Count: 1",
                "  -> 2-5 (Looting I)",
                "  -> 3-9 (Looting II)",
                "  -> 4-12 (Looting III)"
