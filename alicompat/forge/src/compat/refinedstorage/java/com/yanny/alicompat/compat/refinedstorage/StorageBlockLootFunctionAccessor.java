...
public class StorageBlockLootFunctionAccessor extends ConditionalFunction implements IFunctionTooltip {
    public StorageBlockLootFunctionAccessor(LootItemConditionalFunction conditionalFunction) {
    ...
    public TooltipBuilder getTooltip(IServerUtils utils) {
        return TooltipBuilder.array((b) -> {
            ...
            b.showEmpty();
        }, RefinedStorageLang.Functions.COPY_STORAGE_ID);
    }
}
