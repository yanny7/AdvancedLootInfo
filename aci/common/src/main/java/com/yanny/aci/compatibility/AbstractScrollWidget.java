...
public abstract class AbstractScrollWidget {
     ...
     * picture-in-picture render state carries its own scissor rectangle instead of honouring {@link GuiGraphicsExtractor}'
    ...
    private void drawHorizontalMarker(GuiGraphicsExtractor guiGraphics, Rect markerArea) {
