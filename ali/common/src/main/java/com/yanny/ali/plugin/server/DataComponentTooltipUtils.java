...
public class DataComponentTooltipUtils {
    ...
    @Unmodifiable
    @NotNull
    public static TooltipNode getProvidesBannerPatternsTooltip(IServerUtils utils, HolderSet<BannerPattern> value) {
    ...
    @NotNull
    public static TooltipNode getIdentifierTooltip(IServerUtils utils, Identifier value) {
        return utils.getValueTooltip(utils, value).build("ali.property.value.value");
    }
