...
public class OptionalItemPoolEntryAccessor extends BaseAccessor<OptionalItemPoolEntry> implements IEntry, IEntryTooltip {
    @FieldAccessor
    private Item item;
    ...
    public OptionalItemPoolEntryAccessor(OptionalItemPoolEntry parent) {
        super(parent);
    }
