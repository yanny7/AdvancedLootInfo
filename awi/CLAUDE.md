...
Method lookup **walks up the superclass chain** — `place()` is often declared on an abstract base (`CoralFeature`, `AbstractHugeMushroomFeature`), and without the walk those features analyzed zero methods and silently returned nothing.
