...
public class TagForEmeraldsAccessor extends BaseAccessor<GenericTrades.TagForEmeralds<?>> implements IItemListing {
    @FieldAccessor
    ...
    public TagForEmeraldsAccessor(GenericTrades.TagForEmeralds<?> parent) {
        super(parent);
    }
